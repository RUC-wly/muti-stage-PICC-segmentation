...
def l_test(l_path,m_path, model, net_name):
    ...
    for i_l in img_list:
        ...
        ret, seg = cv2.threshold(seg_end, 0.5, 1, cv2.THRESH_BINARY)
        ...
        cv2.imwrite(seg_name, norm(seg_end) * 255, [int(cv2.IMWRITE_JPEG_QUALITY), 95])
...
if __name__ == '__main__':
    ...
    # test_mr_path = r'/data/wly/data/Code/mid_test/'
    # test_lr_path = r'/data/wly/data/Code/low_test/'

    # 全局模型测试
    # Unet
    net_name = 'Global_Unet_F5'
    from model.Unet import UNet
    model = UNet(in_ch=1, out_ch=1, base_ch=32)

    # Unet_PPM
    # net_name = 'Global_Unet_PPM_F5'
    ...
    l_test(test_lr_path,test_mr_path, model, net_name)